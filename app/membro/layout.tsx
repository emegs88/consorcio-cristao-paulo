...
const navItems = [
  ...
  { href: '/membro/simulador', label: 'Simulador', icon: Calculator },
  { href: '/membro/operacoes', label: 'Operacoes', icon: FileText },
  { href: '/membro/cartas', label: 'Cartas', icon: CreditCard },
  { href: '/membro/igreja', label: 'Minha Igreja', icon: Church },
]
